...
# Setup client
finnhub_client = finnhub.Client(api_key="d7bcjthr01qgc9t6tq60d7bcjthr01qgc9t6tq6g")
# Stock candles
...
print(
    finnhub_client.earnings_calendar(
        _from="2020-06-10", to="2020-06-30", symbol="", international=False
    )
)
...
# Upgrade downgrade
print(
    finnhub_client.upgrade_downgrade(symbol="AAPL", _from="2020-01-01", to="2020-06-30")
)
...
print(
    finnhub_client.institutional_portfolio(
        cik="1000097", _from="2022-01-01", to="2022-10-07"
    )
)
print(
    finnhub_client.institutional_ownership(
        "TSLA", "", _from="2022-01-01", to="2022-10-07"
    )
)
